    ...
    <div class="d-flex flex-row">
      <div class="col-2 mobNav">
          <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
            ...
            <li>
              <a href="<?php echo base_url();?>index.php/services" class="nav-link py-3 border-bottom" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Products">
